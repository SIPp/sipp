...
void printAudioHexUS(char const* note, unsigned char const* string, unsigned int size, int extrainfo, int moreinfo)
{
    if ((debugafile != NULL) &&
        (note != NULL) &&
        (string != NULL) &&
        rtpcheck_debug)
    {
        ...
        fprintf(debugafile, "TID: %lu %s %u %d %d [", pthread_self(), note, size, extrainfo, moreinfo);
...
void printVideoHexUS(char const* note, unsigned char const* string, unsigned int size, int extrainfo, int moreinfo)
{
    if ((debugvfile != NULL) &&
        (note != NULL) &&
        (string != NULL) &&
        rtpcheck_debug)
    {
        ...
        fprintf(debugvfile, "TID: %lu %s %u %d %d [", pthread_self(), note, size, extrainfo, moreinfo);
        for (unsigned int i = 0; i < size; i++)
        {
...
void printAudioHex(char const* note, char const* string, unsigned int size, int extrainfo, int moreinfo)
{
    if ((debugafile != NULL) &&
        (note != NULL) &&
        (string != NULL) &&
...
void printVideoHex(char const* note, char const* string, unsigned int size, int extrainfo, int moreinfo)
{
    if ((debugvfile != NULL) &&
        (note != NULL) &&
        (string != NULL) &&
