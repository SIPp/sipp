...
#define MAX_MSG_NAME_SIZE 30
    ...
    *L_ptr1 = '\0' ;
    ...
    // [JLTAG]
    //
    // This code was added by commit "a4e77b02da86c4f0a5e22ec3674ab0bf2ce3cd1d" and causes the RESIPROCATE
    // SIP stack to reject messages since it expects messages using the TCP/TLS transports to end with
    // two CRLF sequences -- so commenting out for now...
    //
